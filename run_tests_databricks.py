"""
Run insurance-whittaker tests on Databricks via the Jobs API (serverless).
"""
...
notebook_path = "/Workspace/Shared/insurance-whittaker-runner"
...
run_waiter = w.jobs.submit(
    run_name="insurance-whittaker-tests",
    tasks=[
        jobs.SubmitTask(
            task_key="run-tests",
